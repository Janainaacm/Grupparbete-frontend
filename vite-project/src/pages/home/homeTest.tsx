...
const Home = () => { 
  ...
  const categories = [
     {id: 1, title: "Frukter", description: "Välj dina favoritfrukter", image:harvestImg , route:"/recept" },
    { id: 2, title: "Grönsaker", description: "Utforska olika grönsaksalternativ", image: teaLeafImg, route:"/recept"},
    ...
    { id: 6, title: "Vegetariska rätter",description: "Hälsosamma och smakrika vegetariska alternativ",image: veganImg,route: "/recept"}
  ];
