...
export const useCocktailAPIState = create<CocktailAPIState>((set) => ({
  ...
  fetchCocktails: async () => {
    try {
     ...
     /*  const response3 = await axios.get(`${COCKTAIL_API_URL}/search.php?f=b`);
      const response4 = await axios.get(`${COCKTAIL_API_URL}/search.php?f=c`);
      const response5 = await axios.get(`${COCKTAIL_API_URL}/search.php?f=d`);
      const response6 = await axios.get(`${COCKTAIL_API_URL}/search.php?f=e`); */
      const response7 = await axios.get(`${COCKTAIL_API_URL}/search.php?f=f`);
     /*  const response8 = await axios.get(`${COCKTAIL_API_URL}/search.php?f=g`);
      const response9 = await axios.get(`${COCKTAIL_API_URL}/search.php?f=h`);
      const response10 = await axios.get(`${COCKTAIL_API_URL}/search.php?f=i`);
      const response11 = await axios.get(`${COCKTAIL_API_URL}/search.php?f=j`);
      const response12= await axios.get(`${COCKTAIL_API_URL}/search.php?f=k`);
      const response13 = await axios.get(`${COCKTAIL_API_URL}/search.php?f=l`);
      const response14 = await axios.get(`${COCKTAIL_API_URL}/search.php?f=m`);
      const response15 = await axios.get(`${COCKTAIL_API_URL}/search.php?f=n`); */
      ...
      /* const response19 = await axios.get(`${COCKTAIL_API_URL}/search.php?f=r`);
      const response20 = await axios.get(`${COCKTAIL_API_URL}/search.php?f=s`);
      const response21 = await axios.get(`${COCKTAIL_API_URL}/search.php?f=t`);
      const response22 = await axios.get(`${COCKTAIL_API_URL}/search.php?f=v`);
      const response24 = await axios.get(`${COCKTAIL_API_URL}/search.php?f=w`);
      const response25 = await axios.get(`${COCKTAIL_API_URL}/search.php?f=y`);
      const response27 = await axios.get(`${COCKTAIL_API_URL}/search.php?f=z`); */
